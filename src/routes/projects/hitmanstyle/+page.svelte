...
<div class="w-full grid max-md:grid-rows-2 md:grid-cols-2 gap-4">
	<Card
...
<Card>
	...
	level.<br />
	Overall I think this project taught me how much of an iterative process level
	development really was. Player's ingenuity gave me the opportunity to create
	new solutions for the gaps that they would find in the tested design. Taking
	player feedback and going back to the drawing board with the data we received
	we were able to focus on routing the player and control their options, this was
	key in the iterative process.
</Card>
