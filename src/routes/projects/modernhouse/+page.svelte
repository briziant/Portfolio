...
<Image src="{base}/modernhouse/3.png" title="Modern House 3" />
<div class="w-full grid grid-cols-2 gap-4">
	<Image src="{base}/modernhouse/4.png" title="Modern House 4" />
	<Image src="{base}/modernhouse/5.png" title="Modern House 5" />
</div>
